...
export const SimpleBuildBadge: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[9998] bg-gradient-to-r from-cyan-900/90 to-blue-900/90 backdrop-blur-sm border border-cyan-500/50 rounded-lg px-4 py-3 shadow-2xl shadow-cyan-500/20 min-w-[200px]">
