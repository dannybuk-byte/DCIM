          ...
          <div className="h-12 flex items-center justify-between px-6 border-b border-[#00d2d3]/20">
            ...
            <div className="flex items-center gap-4 text-[10px]">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2 py-1 bg-[#ffa502]/20 border border-[#ffa502]/50 rounded hover:bg-[#ffa502]/30 transition-colors"
                title="Help & Navigation Guide (Press ?)"
              >
                <HelpCircle size={14} className="text-[#ffa502]" />
                <span className="text-[10px] text-[#ffa502] font-semibold">Help</span>
              </button>
